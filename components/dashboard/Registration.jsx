...
export default function Registration({ onDone }) {
  ...
  const confirmBirthdate = () => {
    ...
    setForm((p) => ({
      ...p,
      birthdate: `${MONTHS[bdMonth]} ${String(bdDay).padStart(2, "0")}, ${bdYear}`,
      age: calcAge(bdYear, bdMonth, bdDay),
    }));
  ...
  const getQ3Label = () =>
    `Q3. What animal ${(answers.injuryType || "bitten/scratched").toLowerCase()} you?`;
  const getQ6Label = () =>
    `Q6. What body part(s) were you ${(answers.injuryType || "bitten/scratched").toLowerCase()}? Please specify.`;
  const getQuestion = (q) => {
  ...
  const handleSave = async () => {
    ...
    if (finalAnswers.animalOwner === "Others")
      finalAnswers.animalOwner = `Others: ${othersText}`;
    if (finalAnswers.animalType === "Others")
      finalAnswers.animalType = `Others: ${othersText}`;
    try {
      const res = await fetch(`${BASE_URL}/registrations/`, {
        method: "POST",
    ...
    <View style={{ padding: 20 }}>
      ...
      {savedList.length === 0 ? (
        ...
        >
          ...
          >
            Tap <Text style={{ fontWeight: "700", color: C.teal }}>＋ New</Text>{" "}
            to register a patient for their first dose at ABTC-CHO.
          </Text>
          <View
            style={{
              backgroundColor: dark ? "#1e2d3d" : "#e3f2fd",
              borderRadius: 10,
              padding: 12,
              borderWidth: 1,
              borderColor: "#2196f3",
          ...
          >
            ...
            <Text style={{ color: C.sub, fontSize: 12, lineHeight: 18 }}>
              • Date of the animal bite or scratch
            </Text>
            <Text style={{ color: C.sub, fontSize: 12, lineHeight: 18 }}>
              • Details about the animal involved
            </Text>
          </View>
        </View>
      ) : (
        <View style={{ gap: 12 }}>
          {savedList.map((entry, index) => {
            const injuryEmoji =
              entry.answers.injuryType === "Bitten" ? "🦷" : "🐾";
            const animalEmoji =
              entry.answers.animalType === "Dog"
                ? "🐕"
                : entry.answers.animalType === "Cat"
                  ? "🐈"
                  : "🐾";
            return (
              <TouchableOpacity
              ...
              >
                ...
                >
                  <Text
                    style={{ fontSize: 13, color: C.teal, fontWeight: "900" }}
                  >
                    {entry.queue_number ||
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: 12, color: C.sub, marginTop: 2 }}>
                    {animalEmoji} {entry.answers.animalType} {injuryEmoji}{" "}
                    {entry.answers.injuryType}
                  </Text>
                  <Text
        ...
        >
          ...
          {q.type === "date" &&
            (answers.incidentDate ? (
              ...
              >
                ...
                >
                  <Text
                    style={{ color: C.red, fontSize: 12, fontWeight: "800" }}
                  >
                    ✕
                  </Text>
                </TouchableOpacity>
                  ...
                  <View key={opt}>
                    <TouchableOpacity
                      style={{
                        ...
                        backgroundColor: selected ? C.tealLight : C.input,
                        gap: 12,
                      }}
          ...
          {q.type === "text" && (
            <TextInput
              style={{
                backgroundColor: C.input,
                borderWidth: 1.5,
                borderColor: answers[q.key] ? C.teal : C.border,
                borderRadius: 12,
                padding: 14,
                color: C.text,
                fontSize: 14,
          ...
          >
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={{ color: C.sub, fontWeight: "700", fontSize: 14 }}>
                ← Back
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                ...
                paddingVertical: 13,
                borderRadius: 12,
                backgroundColor: isAnswered() ? C.teal : C.border,
                alignItems: "center",
          ...
          >
            ...
            {QUESTIONS.slice(0, currentQ).map((prevQ) => {
              ...
              return (
                <View
                  key={prevQ.id}
                  style={{ flexDirection: "row", marginBottom: 4, gap: 6 }}
                >
                  <Text
                  ...
                  <Text
                    style={{ color: C.sub, fontSize: 11, flex: 1 }}
                    numberOfLines={1}
                  >
                    {pq.label.replace(/Q\d\. /, "")}:{" "}
      ...
      >
        ...
        >
          ...
          <View style={{ marginBottom: 16 }}>
            ...
            <View
              style={{
                backgroundColor: form.age ? C.tealLight : C.input,
                borderWidth: 1.5,
                borderColor: form.age ? C.teal : C.border,
                borderRadius: 12,
                paddingHorizontal: 14,
                paddingVertical: 12,
                flexDirection: "row",
            ...
            >
              <Text
                style={{
                  flex: 1,
                  color: form.age ? C.teal : C.sub,
                  fontSize: 14,
                  fontWeight: form.age ? "700" : "400",
                }}
              >
                {form.age
                  ? `${form.age} years old`
                  : "Auto-filled after selecting birthdate"}
              </Text>
              {form.age ? (
          ...
          <Field
            ...
            placeholder="e.g. Brgy. Carmen, Cagayan de Oro City"
            multiline
          />
          <Field
            C={C}
  ...
  const renderView = () => {
    ...
    const queueNumber =
      entry.queue_number || `Q-${String(selectedIndex + 1).padStart(3, "0")}`;
    const Row = ({ label, value }) => (
      <View
        style={{
          paddingVertical: 10,
          borderBottomWidth: 1,
          borderBottomColor: paper.rowBorder,
        }}
      >
        <Text
          style={{
        ...
        <Text
          style={{ color: paper.valueText, fontSize: 14, fontWeight: "600" }}
        >
          {value || "—"}
        </Text>
      </View>
    ...
    return (
      <View style={{ padding: 20 }}>
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={{ color: C.teal, fontSize: 13, fontWeight: "700" }}>
        ...
        >
          ...
          >
            ...
            <Text
              style={{ fontSize: 10, color: paper.subtitleText, marginTop: 2 }}
            >
          ...
          <Text
            style={{
              fontSize: 9,
              color: paper.footerText,
              textAlign: "center",
              marginTop: 16,
            }}
          >
            This form is for ABTC-CHO use only.
          </Text>
        </View>
        <View
          style={{
        ...
        <View style={{ flexDirection: "row", gap: 12, marginBottom: 8 }}>
          <TouchableOpacity
            style={{
              ...
              borderColor: C.red,
              alignItems: "center",
              backgroundColor: dark ? "#2d1a1a" : "#ffebee",
            }}
  ...
  const renderDatePicker = () => {
    const days = Array.from(
      { length: getDaysInMonth(dpYear, dpMonth) },
      (_, i) => i + 1,
    );
    return (
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      justifyContent: "center",
                      alignItems: "center",
                      backgroundColor: selected ? C.teal : C.input,
                      borderWidth: 1,
                      borderColor: selected ? C.teal : C.border,
                    }}
                    onPress={() => setDpDay(d)}
            ...
            <View style={{ flexDirection: "row", gap: 12 }}>
              ...
              <TouchableOpacity
                style={{
                  ...
                  paddingVertical: 14,
                  borderRadius: 12,
                  backgroundColor: dpDay ? C.teal : C.border,
                  alignItems: "center",
                }}
                onPress={confirmDate}
                disabled={!dpDay}
              >
                <Text
                  style={{ color: dpDay ? "#fff" : C.sub, fontWeight: "800" }}
                >
                  ✓ Confirm Date
                </Text>
              </TouchableOpacity>
  ...
  const renderBdayPicker = () => {
    const days = Array.from(
      { length: getDaysInMonth(bdYear, bdMonth) },
      (_, i) => i + 1,
    );
    return (
      <Modal visible={showBdayPicker} transparent animationType="slide">
        ...
        >
          ...
          >
            ...
            >
              Choose your month, year, and day
            </Text>
            <View
              style={{
                flexDirection: "row",
            ...
            <View style={{ flexDirection: "row", gap: 12 }}>
              ...
              <TouchableOpacity
                style={{
                  ...
                  paddingVertical: 14,
                  borderRadius: 12,
                  backgroundColor: bdDay ? C.teal : C.border,
                  alignItems: "center",
                }}
              ...
              >
                <Text
                  style={{ color: bdDay ? "#fff" : C.sub, fontWeight: "800" }}
                >
                  ✓ Confirm Birthdate
                </Text>
              </TouchableOpacity>
