...
const VACCINES_STATIC = [
  {
    ...
    bgDark: "#2d1a1a",
    disease:
      "Rabies infection caused by bites or scratches from infected animals (dogs, cats, etc.)",
  ...
  },
  {
    ...
    sideEffects: [
      ...
      "Mild fever",
      "Small scar on the arm after healing",
    ],
  },
  {
    id: 3,
    ...
    >
      ...
      <View style={styles.cardHeader}>
        <View
          style={[
            styles.iconCircle,
            { backgroundColor: dark ? vaccine.bgDark : vaccine.bgLight },
          ]}
        >
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            <View style={[styles.diseaseTag, { backgroundColor: C.tagBg }]}>
              <Text
                style={[styles.diseaseTagText, { color: vaccine.color }]}
                numberOfLines={1}
              >
        ...
        >
          <Text
            style={{
              color: expanded ? vaccine.color : C.sub,
              fontSize: 12,
              fontWeight: "700",
            }}
          >
      ...
      {expanded && (
        <View style={[styles.cardBody, { borderTopColor: C.border }]}>
          <View style={styles.detailRow}>
            ...
            >
              <Text style={[styles.detailLabelText, { color: vaccine.color }]}>
                🦠 DISEASE
              </Text>
            </View>
          ...
          <View style={styles.detailRow}>
            <View
              style={[
                styles.detailLabel,
                { backgroundColor: dark ? "#1e2928" : "#f0faf9" },
              ]}
            >
              <Text style={[styles.detailLabelText, { color: "#1b7b6b" }]}>
                👶 AGE
              </Text>
            </View>
            <Text style={[styles.detailValue, { color: C.text }]}>
          ...
          <View style={styles.detailRow}>
            ...
            >
              <Text style={[styles.detailLabelText, { color: "#1565c0" }]}>
                💉 DOSES
              </Text>
            </View>
            <Text style={[styles.detailValue, { color: C.text }]}>
          ...
          vaccine.ml_recommended > 0 ? (
            <View style={styles.detailRow}>
              <View
                style={[
                  styles.detailLabel,
                  { backgroundColor: dark ? "#1e2928" : "#e8f5e9" },
                ]}
              >
                <Text style={[styles.detailLabelText, { color: "#2e7d32" }]}>
                  🧪 ML/DOSE
                </Text>
              </View>
              <Text style={[styles.detailValue, { color: C.text }]}>
                {vaccine.ml_recommended} mL
              </Text>
            </View>
          ) : null}
          <View
            style={[
              ...
              {
                backgroundColor: dark ? "#1e2928" : "#fafafa",
                borderColor: C.border,
              },
            ]}
          >
            <Text style={[styles.sideEffectsTitle, { color: C.sub }]}>
              ⚠️ POSSIBLE SIDE EFFECTS
            </Text>
            {vaccine.sideEffects.map((se, i) => (
              <View key={i} style={styles.sideEffectRow}>
                <View
                  style={[styles.dot, { backgroundColor: vaccine.color }]}
                />
                <Text style={[styles.sideEffectText, { color: C.text }]}>
                  {se}
                </Text>
              </View>
            ))}
...
export default function InformationScreen() {
  ...
  return (
    <SafeAreaView
      style={[styles.root, { backgroundColor: topBar }]}
          ...
          >
            {error && (
              ...
              >
                <Text style={{ color: "#e65100", fontSize: 13 }}>
                  ⚠️ Could not load live stock data. Showing static information
                  only.
                </Text>
                <TouchableOpacity
                  onPress={fetchVaccines}
                  style={{ marginTop: 6 }}
                >
                  <Text
                    style={{
            ...
            <View
              style={[
                styles.introBanner,
                {
                  ...
                  borderColor: dark ? "#2e4a46" : "#b2dfdb",
                },
              ]}
            >
              <Text
                style={[
                  styles.introText,
                  { color: dark ? "#7aada8" : "#1b7b6b" },
                ]}
              >
                Tap any vaccine card to view full details including disease,
            ...
            <View style={styles.countRow}>
              ...
              <View
                style={[
                  styles.countBadge,
                  { backgroundColor: dark ? "#1b7b6b" : "#2BAF9E" },
                ]}
              >
