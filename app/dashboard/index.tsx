...
export default function DashboardScreen() {
  ...
  const quickActions = [
    ...
    { label: 'View\nSchedule',   emoji: '📅', color: '#1e88e5', bg: dark ? '#1a2a3d' : '#e3f2fd', onPress: () => router.push('/schedule') },
          ...
          <View style={styles.contentPadding}>
            ...
            <View style={[styles.card, { backgroundColor: C.card, marginBottom: 12 }]}>
              <View style={styles.cardRowHeader}>
                ...
                <Text style={[styles.cardTitle, { color: C.text }]}>Anti-Rabies Vaccine</Text>
              </View>
              <View style={[styles.divider, { backgroundColor: C.divider }]} />
...
const styles = StyleSheet.create({
  ...
  subheading: { fontSize: 12, marginTop: 2, textAlign: 'center', color: 'rgba(255,255,255,0.75)' },
