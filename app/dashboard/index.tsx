        ...
        <View style={styles.contentPadding}>
          ...
          <View style={styles.antiRabiesCard}>
            ...
            <Text style={styles.cardSubtitle}>
              <Text style={{ fontWeight: "bold" }}>Standard Protocol:</Text>{" "}
              3-dose series
            </Text>
            <Text style={styles.cardText}>
              Complete all 3 doses for full protection
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  logoutItem: { marginTop: 20, backgroundColor: "#d07272", borderRadius: 8 },
