            ...
            <View style={[styles.progressCard, { backgroundColor: C.card, borderColor: C.border }]}>
              ...
              <View style={[styles.progressBarBg, { backgroundColor: C.progressBg }]}>
                <View style={[
                  ...
                  { width: `${progressPercent}%` as any, backgroundColor: allRequiredDone ? C.green : C.teal }
                ]} />
              </View>
            ...
            {doses.map((dose) => (
              <View key={dose.id} style={[
                ...
                <View style={styles.doseInfo}>
                  ...
                  {dose.completed && (
                    <Text style={[styles.congratsText, { color: C.green }]}>✓ Done!</Text>
                  )}
                </View>
        ...
        <View style={styles.datePickerOverlay}>
          <View style={[styles.datePickerModal, { backgroundColor: C.card }]}>
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  style={[
                    ...
                    pickedDate?.toDateString() === item.toDateString() && { backgroundColor: C.teal, borderColor: C.teal }
                  ]}
                ...
                >
                  <Text style={[
                    ...
                    { color: C.text },
                    pickedDate?.toDateString() === item.toDateString() && { color: '#fff' }
                  ]}>
                    {item.getDate()}
                  </Text>
                </TouchableOpacity>
            ...
            <View style={styles.datePickerButtons}>
              <TouchableOpacity
                style={[styles.datePickerButton, { backgroundColor: dark ? '#2d1a1a' : '#ffebee', borderWidth: 2, borderColor: C.red }]}
